...
import java.net.URI;
import org.bremersee.WithJwtAuthenticationToken;
...
public class JwtAuthenticationTokenAppenderTest {

  private static JwtAuthenticationTokenAppender appender = new JwtAuthenticationTokenAppender();
