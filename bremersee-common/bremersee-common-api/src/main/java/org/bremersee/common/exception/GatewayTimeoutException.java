...
public class GatewayTimeoutException extends RuntimeException
    ...
    public GatewayTimeoutException() {
        this(Exceptions.GATEWAY_TIMEOUT.getDefaultMessage());
    }
    ...
    public GatewayTimeoutException(Throwable cause) {
        super(Exceptions.GATEWAY_TIMEOUT.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.GATEWAY_TIMEOUT.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.GATEWAY_TIMEOUT.getCustomStatusCode();
    }
