...
public class PaymentRequiredException extends RuntimeException
    ...
    public PaymentRequiredException() {
        this(StatusCode.PAYMENT_REQUIRED.getDefaultMessage());
    }
    ...
    public PaymentRequiredException(Throwable cause) {
        super(StatusCode.PAYMENT_REQUIRED.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.PAYMENT_REQUIRED.getStatusCodeValue();
    }
