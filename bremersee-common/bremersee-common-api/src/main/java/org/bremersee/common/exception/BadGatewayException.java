...
public class BadGatewayException extends RuntimeException
    ...
    public BadGatewayException() {
        this(Exceptions.BAD_GATEWAY.getDefaultMessage());
    }
    ...
    public BadGatewayException(Throwable cause) {
        super(Exceptions.BAD_GATEWAY.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.BAD_GATEWAY.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.BAD_GATEWAY.getCustomStatusCode();
    }
