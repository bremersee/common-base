...
public class UnsupportedMediaTypeException extends RuntimeException
    ...
    public UnsupportedMediaTypeException() {
        this(Exceptions.UNSUPPORTED_MEDIA_TYPE.getDefaultMessage());
    }

    /**
     * Constructs a new runtime exception with the specified detail message. The
     * cause is not initialized, and may sbe initialized by a call
     * to {@link #initCause}.
     *
    ...
    public UnsupportedMediaTypeException(Throwable cause) {
        super(Exceptions.UNSUPPORTED_MEDIA_TYPE.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.UNSUPPORTED_MEDIA_TYPE.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.UNSUPPORTED_MEDIA_TYPE.getCustomStatusCode();
    }
