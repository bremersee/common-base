...
public class AlreadyExistsException extends RuntimeException
    ...
    public AlreadyExistsException() {
        this(Exceptions.ALREADY_EXISTS.getDefaultMessage());
    }
    ...
    public AlreadyExistsException(Throwable cause) {
        super(Exceptions.ALREADY_EXISTS.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.ALREADY_EXISTS.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.ALREADY_EXISTS.getCustomStatusCode();
    }
