...
public class NotFoundException extends RuntimeException
    ...
    public NotFoundException() {
        this(Exceptions.NOT_FOUND.getDefaultMessage());
    }
    ...
    public NotFoundException(Throwable cause) {
        super(Exceptions.NOT_FOUND.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.NOT_FOUND.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.NOT_FOUND.getCustomStatusCode();
    }
