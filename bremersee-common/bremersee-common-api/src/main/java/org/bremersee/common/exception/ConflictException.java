...
public class ConflictException extends RuntimeException
    ...
    public ConflictException() {
        this(Exceptions.CONFLICT.getDefaultMessage());
    }
    ...
    public ConflictException(Throwable cause) {
        super(Exceptions.CONFLICT.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.CONFLICT.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.CONFLICT.getCustomStatusCode();
    }
