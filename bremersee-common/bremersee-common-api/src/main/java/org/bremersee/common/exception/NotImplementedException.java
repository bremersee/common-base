...
public class NotImplementedException extends RuntimeException
    ...
    public NotImplementedException() {
        this(Exceptions.NOT_IMPLEMENTED.getDefaultMessage());
    }
    ...
    public NotImplementedException(Throwable cause) {
        super(Exceptions.NOT_IMPLEMENTED.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.NOT_IMPLEMENTED.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.NOT_IMPLEMENTED.getCustomStatusCode();
    }
