...
public class RequestEntityTooLargeException extends RuntimeException
    ...
    public RequestEntityTooLargeException() {
        this(Exceptions.REQUEST_ENTITY_TOO_LARGE.getDefaultMessage());
    }
    ...
    public RequestEntityTooLargeException(Throwable cause) {
        super(Exceptions.REQUEST_ENTITY_TOO_LARGE.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.REQUEST_ENTITY_TOO_LARGE.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.REQUEST_ENTITY_TOO_LARGE.getCustomStatusCode();
    }
