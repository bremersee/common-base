...
public class RequestEntityTooLargeException extends RuntimeException
    ...
    public RequestEntityTooLargeException() {
        this(StatusCode.REQUEST_ENTITY_TOO_LARGE.getDefaultMessage());
    }
    ...
    public RequestEntityTooLargeException(Throwable cause) {
        super(StatusCode.REQUEST_ENTITY_TOO_LARGE.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.REQUEST_ENTITY_TOO_LARGE.getStatusCodeValue();
    }
