...
public class GoneException extends RuntimeException
    ...
    public GoneException() {
        this(Exceptions.GONE.getDefaultMessage());
    }
    ...
    public GoneException(Throwable cause) {
        super(Exceptions.GONE.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.GONE.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.GONE.getCustomStatusCode();
    }
