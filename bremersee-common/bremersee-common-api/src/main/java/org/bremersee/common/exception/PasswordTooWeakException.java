...
public class PasswordTooWeakException extends RuntimeException
    ...
    public PasswordTooWeakException() {
        this(Exceptions.PASSWORD_TOO_WEAK.getDefaultMessage());
    }
    ...
    public PasswordTooWeakException(Throwable cause) {
        super(Exceptions.PASSWORD_TOO_WEAK.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.PASSWORD_TOO_WEAK.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.PASSWORD_TOO_WEAK.getCustomStatusCode();
    }
