...
public class PasswordTooWeakException extends RuntimeException
    ...
    public PasswordTooWeakException() {
        this(StatusCode.PASSWORD_TOO_WEAK.getDefaultMessage());
    }
    ...
    public PasswordTooWeakException(Throwable cause) {
        super(StatusCode.PASSWORD_TOO_WEAK.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.PASSWORD_TOO_WEAK.getStatusCodeValue();
    }
