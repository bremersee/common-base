...
public class HttpVersionNotSupportedException extends RuntimeException
    ...
    public HttpVersionNotSupportedException() {
        this(Exceptions.HTTP_VERSION_NOT_SUPPORTED.getDefaultMessage());
    }
    ...
    public HttpVersionNotSupportedException(Throwable cause) {
        super(Exceptions.HTTP_VERSION_NOT_SUPPORTED.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.HTTP_VERSION_NOT_SUPPORTED.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.HTTP_VERSION_NOT_SUPPORTED.getCustomStatusCode();
    }
