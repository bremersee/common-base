...
public class LengthRequiredException extends RuntimeException
    ...
    public LengthRequiredException() {
        this(StatusCode.LENGTH_REQUIRED.getDefaultMessage());
    }
    ...
    public LengthRequiredException(Throwable cause) {
        super(StatusCode.LENGTH_REQUIRED.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.LENGTH_REQUIRED.getStatusCodeValue();
    }
