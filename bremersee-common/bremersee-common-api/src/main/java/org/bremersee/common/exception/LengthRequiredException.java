...
public class LengthRequiredException extends RuntimeException
    ...
    public LengthRequiredException() {
        this(Exceptions.LENGTH_REQUIRED.getDefaultMessage());
    }
    ...
    public LengthRequiredException(Throwable cause) {
        super(Exceptions.LENGTH_REQUIRED.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.LENGTH_REQUIRED.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.LENGTH_REQUIRED.getCustomStatusCode();
    }
