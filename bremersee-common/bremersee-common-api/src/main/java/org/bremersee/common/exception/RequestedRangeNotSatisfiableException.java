...
public class RequestedRangeNotSatisfiableException extends RuntimeException
    ...
    public RequestedRangeNotSatisfiableException() {
        this(Exceptions.REQUESTED_RANGE_NOT_SATISFIABLE.getDefaultMessage());
    }
    ...
    public RequestedRangeNotSatisfiableException(Throwable cause) {
        super(Exceptions.REQUESTED_RANGE_NOT_SATISFIABLE.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.REQUESTED_RANGE_NOT_SATISFIABLE.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.REQUESTED_RANGE_NOT_SATISFIABLE.getCustomStatusCode();
    }
