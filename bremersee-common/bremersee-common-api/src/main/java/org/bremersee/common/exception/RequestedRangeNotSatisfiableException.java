...
public class RequestedRangeNotSatisfiableException extends RuntimeException
    ...
    public RequestedRangeNotSatisfiableException() {
        this(StatusCode.REQUESTED_RANGE_NOT_SATISFIABLE.getDefaultMessage());
    }
    ...
    public RequestedRangeNotSatisfiableException(Throwable cause) {
        super(StatusCode.REQUESTED_RANGE_NOT_SATISFIABLE.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.REQUESTED_RANGE_NOT_SATISFIABLE.getStatusCodeValue();
    }
