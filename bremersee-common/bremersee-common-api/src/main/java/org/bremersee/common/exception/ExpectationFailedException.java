...
public class ExpectationFailedException extends RuntimeException
    ...
    public ExpectationFailedException() {
        this(Exceptions.EXPECTATION_FAILED.getDefaultMessage());
    }
    ...
    public ExpectationFailedException(Throwable cause) {
        super(Exceptions.EXPECTATION_FAILED.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.EXPECTATION_FAILED.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.EXPECTATION_FAILED.getCustomStatusCode();
    }
