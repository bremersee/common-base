...
public class ExpectationFailedException extends RuntimeException
    ...
    public ExpectationFailedException() {
        this(StatusCode.EXPECTATION_FAILED.getDefaultMessage());
    }
    ...
    public ExpectationFailedException(Throwable cause) {
        super(StatusCode.EXPECTATION_FAILED.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.EXPECTATION_FAILED.getStatusCodeValue();
    }
