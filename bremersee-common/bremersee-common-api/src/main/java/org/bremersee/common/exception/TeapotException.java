...
public class TeapotException extends RuntimeException
    ...
    public TeapotException() {
        this(Exceptions.I_AM_A_TEAPOT.getDefaultMessage());
    }
    ...
    public TeapotException(Throwable cause) {
        super(Exceptions.I_AM_A_TEAPOT.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.I_AM_A_TEAPOT.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.I_AM_A_TEAPOT.getCustomStatusCode();
    }
