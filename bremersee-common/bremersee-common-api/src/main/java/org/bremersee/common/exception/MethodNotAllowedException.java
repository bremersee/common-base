...
public class MethodNotAllowedException extends RuntimeException
    ...
    public MethodNotAllowedException() {
        this(Exceptions.METHOD_NOT_ALLOWED.getDefaultMessage());
    }
    ...
    public MethodNotAllowedException(Throwable cause) {
        super(Exceptions.METHOD_NOT_ALLOWED.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.METHOD_NOT_ALLOWED.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.METHOD_NOT_ALLOWED.getCustomStatusCode();
    }
