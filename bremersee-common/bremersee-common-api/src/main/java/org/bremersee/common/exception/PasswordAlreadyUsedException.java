...
public class PasswordAlreadyUsedException extends RuntimeException
    ...
    public PasswordAlreadyUsedException() {
        this(StatusCode.PASSWORD_ALREADY_USED.getDefaultMessage());
    }
    ...
    public PasswordAlreadyUsedException(Throwable cause) {
        super(StatusCode.PASSWORD_ALREADY_USED.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.PASSWORD_ALREADY_USED.getStatusCodeValue();
    }
