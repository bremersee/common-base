...
public class PasswordAlreadyUsedException extends RuntimeException
    ...
    public PasswordAlreadyUsedException() {
        this(Exceptions.PASSWORD_ALREADY_USED.getDefaultMessage());
    }
    ...
    public PasswordAlreadyUsedException(Throwable cause) {
        super(Exceptions.PASSWORD_ALREADY_USED.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.PASSWORD_ALREADY_USED.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.PASSWORD_ALREADY_USED.getCustomStatusCode();
    }
