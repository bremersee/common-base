...
public class PreconditionFailedException extends RuntimeException
    ...
    public PreconditionFailedException() {
        this(Exceptions.PRECONDITION_FAILED.getDefaultMessage());
    }
    ...
    public PreconditionFailedException(Throwable cause) {
        super(Exceptions.PRECONDITION_FAILED.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.PRECONDITION_FAILED.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.PRECONDITION_FAILED.getCustomStatusCode();
    }
