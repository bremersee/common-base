...
public class NotAcceptableException extends RuntimeException
    ...
    public NotAcceptableException() {
        this(Exceptions.NOT_ACCEPTABLE.getDefaultMessage());
    }
    ...
    public NotAcceptableException(Throwable cause) {
        super(Exceptions.NOT_ACCEPTABLE.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.NOT_ACCEPTABLE.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.NOT_ACCEPTABLE.getCustomStatusCode();
    }
