...
public class ServiceUnavailableException extends RuntimeException
    ...
    public ServiceUnavailableException() {
        this(Exceptions.SERVICE_UNAVAILABLE.getDefaultMessage());
    }
    ...
    public ServiceUnavailableException(Throwable cause) {
        super(Exceptions.SERVICE_UNAVAILABLE.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.SERVICE_UNAVAILABLE.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.SERVICE_UNAVAILABLE.getCustomStatusCode();
    }
