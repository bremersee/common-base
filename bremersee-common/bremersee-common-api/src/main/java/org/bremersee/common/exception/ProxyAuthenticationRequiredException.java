...
public class ProxyAuthenticationRequiredException extends RuntimeException
    ...
    public ProxyAuthenticationRequiredException() {
        this(StatusCode.PROXY_AUTHENTICATION_REQUIRED.getDefaultMessage());
    }
    ...
    public ProxyAuthenticationRequiredException(Throwable cause) {
        super(StatusCode.PROXY_AUTHENTICATION_REQUIRED.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.PROXY_AUTHENTICATION_REQUIRED.getStatusCodeValue();
    }
