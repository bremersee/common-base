...
public class ProxyAuthenticationRequiredException extends RuntimeException
    ...
    public ProxyAuthenticationRequiredException() {
        this(Exceptions.PROXY_AUTHENTICATION_REQUIRED.getDefaultMessage());
    }
    ...
    public ProxyAuthenticationRequiredException(Throwable cause) {
        super(Exceptions.PROXY_AUTHENTICATION_REQUIRED.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.PROXY_AUTHENTICATION_REQUIRED.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.PROXY_AUTHENTICATION_REQUIRED.getCustomStatusCode();
    }
