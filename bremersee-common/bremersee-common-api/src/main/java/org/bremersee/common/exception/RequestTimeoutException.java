...
public class RequestTimeoutException extends RuntimeException
    ...
    public RequestTimeoutException() {
        this(Exceptions.REQUEST_TIMED_OUT.getDefaultMessage());
    }
    ...
    public RequestTimeoutException(Throwable cause) {
        super(Exceptions.REQUEST_TIMED_OUT.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.REQUEST_TIMED_OUT.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.REQUEST_TIMED_OUT.getCustomStatusCode();
    }
