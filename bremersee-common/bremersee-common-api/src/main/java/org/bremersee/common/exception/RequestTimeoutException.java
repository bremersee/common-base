...
public class RequestTimeoutException extends RuntimeException
    ...
    public RequestTimeoutException() {
        this(StatusCode.REQUEST_TIMED_OUT.getDefaultMessage());
    }
    ...
    public RequestTimeoutException(Throwable cause) {
        super(StatusCode.REQUEST_TIMED_OUT.getDefaultMessage(), cause);
    }
    ...
    public int getStatusCode() {
        return StatusCode.REQUEST_TIMED_OUT.getStatusCodeValue();
    }
