 ...
 */
public class BadEmailAddressException extends IllegalArgumentException
    ...
    public BadEmailAddressException() {
        this(Exceptions.BAD_EMAIL_ADDRESS.getDefaultMessage());
    }
    ...
    public BadEmailAddressException(Throwable cause) {
        super(Exceptions.BAD_EMAIL_ADDRESS.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.BAD_EMAIL_ADDRESS.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.BAD_EMAIL_ADDRESS.getCustomStatusCode();
    }
