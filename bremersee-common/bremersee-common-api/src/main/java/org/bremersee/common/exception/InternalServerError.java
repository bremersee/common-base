...
public class InternalServerError extends RuntimeException
    ...
    public InternalServerError() {
        this(Exceptions.INTERNAL_SERVER_ERROR.getDefaultMessage());
    }
    ...
    public InternalServerError(Throwable cause) {
        super(Exceptions.INTERNAL_SERVER_ERROR.getDefaultMessage(), cause);
    }
    ...
    public int getHttpStatusCode() {
        return Exceptions.INTERNAL_SERVER_ERROR.getHttpStatusCode();
    }

    @Override
    public int getCustomStatusCode() {
        return Exceptions.INTERNAL_SERVER_ERROR.getCustomStatusCode();
    }
